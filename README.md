# Moksy - Real-time Event Ticketing Platform
...
git clone https://github.com/Moxsahil/Next-JS-Ticket-Seller-SAAS-Application.git
...
1. [Create a Convex account by Clicking here!](https://www.convex.dev)
