  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#3494E6] to-[#EC6EAD] border-blue-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white/20 rounded-xl shadow-sm overflow-hidden">
          {imageUrl && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-emerald-200 p-4 rounded-lg border border-gray-100">
                ...
                <div className="bg-orange-100 border border-blue-100 rounded-lg p-6">
